...
const COLORS = ['#4F46E5', '#EC4899', '#6366F1', '#F472B6'];
        ...
        <div className="bg-background">
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="text-center">
                    <h1 className="text-4xl font-extrabold text-copy sm:text-5xl">Platform Reports</h1>
                ...
                <div className="mt-16 grid md:grid-cols-2 gap-12">
                    <div className="bg-surface p-6 rounded-lg shadow-lg">
                        <h3 className="text-xl font-bold mb-6 text-center text-copy">Donations by Category</h3>
                    ...
                    <div className="bg-surface p-6 rounded-lg shadow-lg">
                        <h3 className="text-xl font-bold mb-6 text-center text-copy">Funding Sources</h3>
                         <div style={{ width: '100%', height: 300 }}>
                            <ResponsiveContainer>
                                <PieChart>
                                    <Pie
