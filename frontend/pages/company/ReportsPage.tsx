...
const CompanyReportsPage: React.FC = () => {
  ...
  const fetchDonations = useCallback(async () => {
    setLoading(true);
    try {
      const response = await companyAPI.getDonationHistory({});
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white">My Donation Reports</h1>
      <p className="text-gray-600 dark:text-gray-400">Track your company's contributions and social impact.</p>
      ...
      <div className="bg-white dark:bg-brand-dark-200 shadow-md rounded-lg overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="bg-white dark:bg-brand-dark-200 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            {!loading && donations.length === 0 && <tr><td colSpan={5} className="text-center p-4">No donations found.</td></tr>}
